...
split_bib <- function(bib, chunk_size = 5) {
  ...
  for (i in 1:chunks) {
    ...
    for (j in start:end) {
      entry <- bib[j]
      cat(sprintf("[%d] ", j))
      print(entry, .opts = list(bib.style = "numeric", style = "text"))
      cat("\n\n")
    }
  }
}
...
<div style="text-align: center;">
  <img src="images/learned_sys.png" alt="Diagram of System concatenating stage" style="width: auto; height: 350px;">
...
## System Model
In the experiment, the differential drive mobile robot system is the chosen for our study case. The robot will be deployed inside the PyBullet environment which is the main objective environment that we will explore with our implementation. The hardware the we are experiment on is the desktop running Ubuntu OS, RTX 3080Ti 10GB VRAM and RAM spec 16GB. <br>
The system model of this differential drive 4-wheeled mobile robot captures both linear and rotational motion of the system.
---
Here are the parameter that we use inside the PyBullet environment for our simulation
<div style="text-align: center;">
  <img src="images/robot_table.png" alt="robot params" style="width: auto; height: 250px;">
</div>
---
## System Identification using each Controller In Pybullet Environment
**Design Deep Neural Network** <br>
In this step, we process data collection based on the simulation environment. We collect the data by implementing the nominal system with the MPC controller and MPPI controller. Then, we design a simple 5-layer Multilayer Perceptron or Deep Neural Network with 3 hidden layers. Each neuron in the hidden layers is activated using the Tanh activation function. This Deep Neural Network Model has 792,579 to calculate during each epoch of training step.

<div style="text-align: center;">
  <img src="images/dnn_drawing.png" alt="DNN 5 MLPS" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Figure 3.1 Neural Network Model.</p>
</div>
---
## Model Predictive Control with Learned Dyanmcis using Acados
**Training the Neural Network** <br>
<div style="text-align: center;">
  <img src="images/mpc_dnn_params.png" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Table 3.1 Comparison of DNN Training Loss for MPPI.</p>
</div>
---
**Training Neural Network**
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/loss_mlp.png" alt="Prediction horizon" style="width: auto; height: 300px;">
  </div>
  <div style="flex: 1;">
    <img src="images/loss_mlp_mae.png" alt="Obstacle avoidance" style="width: auto; height: 300px;">
  </div>
</div>
<p style="text-align: center; font-style: italic;">Figure 3.2 Training and Validation Loss of MLP.</p>
---
**Training Neural Network**
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/loss_resnet18.png" alt="Prediction horizon" style="width: auto; height: 300px;">

  </div>
  <div style="flex: 1;">
    <img src="images/loss_resnet18_mae.png" alt="Obstacle avoidance" style="width: auto; height: 300px;">
  </div>
</div>
<p style="text-align: center; font-style: italic;">Figure 3.3 Training and Validation Loss of Resnet18.</p>
---
**Training Neural Network**
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/loss_resnet50.png" alt="Prediction horizon" style="width: auto; height: 300px;">

  </div>
  <div style="flex: 1;">
    <img src="images/loss_resnet50_mae.png" alt="Obstacle avoidance" style="width: auto; height: 300px;">
  </div>
</div>
<p style="text-align: center; font-style: italic;">Figure 3.4 Training and Validation Loss of Resnet50.</p>
---
** Normal Run with Dynamics Obstacle **
<video width="100%" height="400" controls autoplay>
  <source src="videos/mpc_diff_dynamics_obs.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
---
**Compare MPC performance nominal model vs learned model** <br>
The Obstacle Parameter, lists the properties of three obstacles, including their
positions, velocities, and radii
<div style="text-align: center;">
  <img src="images/obstacle_params.png" alt="Obstacle Params" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Table 3.2 Obstacle Parameter.</p>
</div>
---
**Compare MPC performance nominal model vs learned model** <br>
The MPC Parameter Values, shows the configuration parameters for the Model
Predictive Control (MPC) algorithm, including cost matrices, state and control bounds, predic-
tion horizon, time step, total prediction time, and cost type.
<div style="text-align: center;">
  <img src="images/mpc_exp_params.png" alt="MPC Params" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Table 3.3 MPC Parameter.</p>
</div>
---
**Compare MPC performance nominal model vs learned model** <br>
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/state_errors_no_dnn.png" alt="" style="width: auto; height: 250px;">
    <p style="text-align: center; font-style: italic;">Figure 3.5 State Errors without DNN.</p>
  </div>
  <div style="flex: 1;">
    <img src="images/state_errors_dnn.png" alt="Obstacle avoidance" style="width: auto; height: 250px;">
...
**Compare MPC performance nominal model vs learned model** <br>
<div style="text-align: center;">
  <img src="images/state_reference_and_feedback.png" alt="" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Figure 3.7 State Feedback and the Input Control with Nominal Model.</p>
</div>
---
**Compare MPC performance nominal model vs learned model** <br>
<div style="text-align: center;">
  <img src="images/state_reference_and_feedback_dnn.png" alt="" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Figure 3.8 State Feedback and the Input Control with Nominal Model fused with Data Driven
Model.</p>
---
</div>
<div class="video-container">
  <div class="video-wrapper">
    <h2>Video 1: diff_mpc_bullet.mp4</h2>
    <video width="100%" height="400" controls autoplay>
  ...
  <div class="video-wrapper">  
    <h2>Video 2: diff_mpc_dnn_bullet.mp4</h2>
    <video width="100%" height="400" controls autoplay>
...
<div style="text-align: center;">
  ...
  <p style="text-align: center; font-style: italic;">Table 3.4 Comparison of DNN Training Loss for MPPI.</p>
</div>
---
**Training Neural Network**
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/loss_mppi_mlp.png" alt="Prediction horizon" style="width: auto; height: 300px;">

  </div>
  <div style="flex: 1;">
    <img src="images/loss_mppi_mlp_mae.png" alt="Obstacle avoidance" style="width: auto; height: 300px;">
  </div>
</div>
<p style="text-align: center; font-style: italic;">Figure 3.2 Training and Validation Loss of MLP.</p>
---
...
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/loss_mppi_resnet18.png" alt="Prediction horizon" style="width: auto; height: 300px;">

  </div>
  <div style="flex: 1;">
    <img src="images/loss_mppi_resnet18_mae.png" alt="Obstacle avoidance" style="width: auto; height: 300px;">
  </div>
</div>
<p style="text-align: center; font-style: italic;">Figure 3.3 Training and Validation Loss of Resnet18.</p>
---
...
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/loss_mppi_resnet50.png" alt="Prediction horizon" style="width: auto; height: 300px;">

  </div>
  <div style="flex: 1;">
    <img src="images/loss_mppi_resnet50_mae.png" alt="Obstacle avoidance" style="width: auto; height: 300px;">
  </div>
</div>
<p style="text-align: center; font-style: italic;">Figure 3.4 Training and Validation Loss of Resnet50.</p>
---
...
positions, velocities, and radii
<div style="text-align: center;">
  <img src="images/obstacle_params.png" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Table 3.5 Obstacle Parameter.</p>
</div>
---
**Compare MPPI performance nominal model vs learned model**
The result of MPPI controller is also similar to MPC. It shows that the DNN model improves the
performance on the controller. The MPPI Controller using the sampling size 𝐾 over a prediction
horizons of 𝑁.
<div style="text-align: center;">
  <img src="images/mppi_exp_params.png" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Table 3.6 MPPI Parameter.</p>
</div>
---
**Compare MPPI performance nominal model vs learned model**
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; margin-right: 20px;">
    <img src="images/mppi_state_errors_mppi.png" alt="" style="width: auto; height: 250px;">
    <p style="text-align: center; font-style: italic;">Figure 3.6 State Errors without DNN.</p>
  </div>
  <div style="flex: 1;">
    <img src="images/mppi_state_errors_mppi_dnn.png" alt="Obstacle avoidance" style="width: auto; height: 250px;">
    <p style="text-align: center; font-style: italic;">Figure 3.7 State Errors with DNN.</p>
  </div>
</div>
---
**Compare MPPI performance nominal model vs learned model**
<div style="text-align: center;">
  <img src="images/state_reference_and_feedback_mppi.png" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Figure 3.8 State reference and state feedback using Nominal Model
Model.</p>
</div>
---
**Compare MPPI performance nominal model vs learned model**
<div style="text-align: center;">
  <img src="images/state_reference_and_feedback_mppi_dnn.png" style="width: auto; height: 250px;">
  <p style="text-align: center; font-style: italic;">Figure 3.9 State reference and state feedback using Nominal Model fused with Data Driven
Model.</p>
</div>
---
**Compare MPPI performance nominal model vs learned model**
<div style="text-align: center;">
  <img src="images/mppi_control_inputs_smooth_dnn.png" style="width: auto; height: 250px;"">
  <p style="text-align: center; font-style: italic;">Figure 3.10 Input Control of Nominal Model
Model.</p>
</div>
---
**Compare MPPI performance nominal model vs learned model**
...
<div class="video-container">
  <div class="video-wrapper">
    <h2>Video 1: diff_mppi_bullet.mp4</h2>
    <video width="100%" height="400" controls autoplay>
      <source src="videos/diff_mpc_bullet.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
  ...
  <div class="video-wrapper">  
    <h2>Video 2: diff_mppi_dnn_bullet.mp4</h2>
    <video width="100%" height="400" controls autoplay>
      <source src="videos/diff_mpc_dnn_bullet.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
